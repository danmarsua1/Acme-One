...
<acme:form readonly="true">
	...
	<acme:input-textbox code="inventor.toolkit.form.label.publish" path="publish"/>
	<acme:input-textbox code="inventor.toolkit.form.label.link" path="link"/>
	<acme:input-textbox code="inventor.toolkit.form.label.totalPrice" path="totalPrice"/>
